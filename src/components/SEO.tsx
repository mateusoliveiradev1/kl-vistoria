...
export function SEO({ title, description, keywords, image, url }: SEOProps) {
  ...
  const localBusinessData = {
    ...
    areaServed: [
      {
        "@type": "City",
        name: "Goiânia",
        sameAs: "https://pt.wikipedia.org/wiki/Goiânia",
      },
      {
        "@type": "City",
        name: "Aparecida de Goiânia",
        sameAs: "https://pt.wikipedia.org/wiki/Aparecida_de_Goiânia",
      },
      {
        "@type": "City",
        name: "Senador Canedo",
        sameAs: "https://pt.wikipedia.org/wiki/Senador_Canedo",
      },
    ],
    address: {
      "@type": "PostalAddress",
    ...
    sameAs: [COMPANY_INFO.social.instagram, COMPANY_INFO.social.facebook],
  };
